...
const copyWebpackPlugin = require("copy-webpack-plugin"); // para copiar los estilos CSS hacia nuestro archivo
...
module.exports = {
  ...
  module: {
    //Se crea un modulo con las reglas de BABEL necesarias que vamos a utilizar.
    rules: [
      //Reglas
      {
        // Estructura de Babel
  ...
  plugins: [
    ...
    new copyWebpackPlugin({
      // para crear la conexion de nuestros estilos css a nuestro archivo general de render
      patterns: [
        {
          from: "./src/styles/styles.css",
          to: "", // en este momento no necesita configuracion dice el profesor
        },
      ],
    }),
  ],
